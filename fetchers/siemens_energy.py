...
class SiemensEnergyFetcher(CompanyFetcher):
    """Siemens Energy 爬蟲"""

    company_id = "siemens_energy"
    company_name = "Siemens Energy"
    news_url = "https://www.siemensenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.siemensenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Siemens Energy")
        return documents
