...
class McphyFetcher(CompanyFetcher):
    """McPhy Energy 爬蟲"""

    company_id = "mcphy"
    company_name = "McPhy Energy"
    news_url = "https://www.mcphyenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.mcphyenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from McPhy Energy")
        return documents
