...
class NikolaFetcher(CompanyFetcher):
    """Nikola 爬蟲"""

    company_id = "nikola"
    company_name = "Nikola"
    news_url = "https://www.nikola.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Nikola")
        return documents
