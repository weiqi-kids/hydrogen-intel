...
class FuelcellFetcher(CompanyFetcher):
    """FuelCell Energy 爬蟲"""

    company_id = "fuelcell"
    company_name = "FuelCell Energy"
    news_url = "https://www.fuelcellenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.fuelcellenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from FuelCell Energy")
        return documents
