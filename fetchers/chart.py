...
class ChartFetcher(CompanyFetcher):
    """Chart Industries 爬蟲"""

    company_id = "chart"
    company_name = "Chart Industries"
    news_url = "https://www.chartindustries.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.chartindustries.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Chart Industries")
        return documents
