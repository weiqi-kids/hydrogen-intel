...
class AirLiquideFetcher(CompanyFetcher):
    """Air Liquide 爬蟲"""

    company_id = "air_liquide"
    company_name = "Air Liquide"
    news_url = "https://www.airliquide.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.airliquide.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Air Liquide")
        return documents
