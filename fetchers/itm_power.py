...
class ItmPowerFetcher(CompanyFetcher):
    """ITM Power 爬蟲"""

    company_id = "itm_power"
    company_name = "ITM Power"
    news_url = "https://www.itmpower.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.itmpower.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from ITM Power")
        return documents
