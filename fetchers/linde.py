...
class LindeFetcher(CompanyFetcher):
    """Linde 爬蟲"""

    company_id = "linde"
    company_name = "Linde"
    news_url = "https://www.linde.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Linde")
        return documents
