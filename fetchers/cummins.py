...
class CumminsFetcher(CompanyFetcher):
    """Cummins 爬蟲"""

    company_id = "cummins"
    company_name = "Cummins"
    news_url = "https://www.cummins.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Cummins")
        return documents
