...
class BloomEnergyFetcher(CompanyFetcher):
    """Bloom Energy 爬蟲"""

    company_id = "bloom_energy"
    company_name = "Bloom Energy"
    news_url = "https://www.bloomenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.bloomenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Bloom Energy")
        return documents
