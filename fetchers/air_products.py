...
class AirProductsFetcher(CompanyFetcher):
    """Air Products 爬蟲"""

    company_id = "air_products"
    company_name = "Air Products"
    news_url = "https://www.airproducts.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.airproducts.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Air Products")
        return documents
