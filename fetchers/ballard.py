...
class BallardFetcher(CompanyFetcher):
    """Ballard Power Systems 爬蟲"""

    company_id = "ballard"
    company_name = "Ballard Power Systems"
    news_url = "https://www.ballardpowersystems.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.ballardpowersystems.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ballard Power Systems")
        return documents
