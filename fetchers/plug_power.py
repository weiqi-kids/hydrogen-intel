...
class PlugPowerFetcher(CompanyFetcher):
    """Plug Power 爬蟲"""

    company_id = "plug_power"
    company_name = "Plug Power"
    news_url = "https://www.plugpower.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.plugpower.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Plug Power")
        return documents
