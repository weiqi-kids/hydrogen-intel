...
class ThyssenkruppNuceraFetcher(CompanyFetcher):
    """thyssenkrupp nucera 爬蟲"""

    company_id = "thyssenkrupp_nucera"
    company_name = "thyssenkrupp nucera"
    news_url = "https://www.thyssenkruppnucera.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.thyssenkruppnucera.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from thyssenkrupp nucera")
        return documents
...
if __name__ == "__main__":
    fetcher = ThyssenkruppNuceraFetcher()
